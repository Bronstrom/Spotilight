...
### Viewing and Managing Multiple Playlists

To navigate to the "List Playlist" page where you can view all of your playlists, click on the "Playlists" tab within the top navigation.
...
You have a few options to sort your playlists, which organize how you view your playlists. Select the "Sort" dropdown to choose one of the following options:

##### Newest First

Sort playlist ordered by the user's most recently created playlists.

##### Oldest First

Sort playlist ordered by the user's least recently created playlists.
...
Sort playlists reverse alphabetically by title.

##### Owner

Sort playlists by owner display name aphabetically

##### Total Tracks

Sort playlists by the total number of tracks from highest to lowest.

#### Filtering (Playlists)

You have a few options to filter your playlists, which show and hide playlists from the playlist list page. Select the "Filter" dropdown to choose one of the following options:
...
View playlists you are not showing on your public profile.

##### Private Playlists Only

View the playlists you share on your public profile.
...
Sort tracks ordered by the user.

##### Newest First

Sort tracks ordered by the user's most recently added tracks.

##### Oldest First

Sort tracks ordered by the user's least recently added tracks.
...
Sort tracks reverse alphabetically by title.

##### Lead Artist

Sort tracks ordered by the lead artist alphabeetically.
...
Show all of the tracks in the current playlist.

##### No Local Files Only

Hide local track files in the current playlist.

##### Local Files Only

Show only locally added tracks in the current playlist.

##### No Explicits Only

Hide tracks with explicit words in them in the current playlist.

##### Explicits Only

Show only tracks with explicit words in them in the current playlist.
...
Select all tracks in the current playlist.

##### Unselect All Items

Unselect all tracks in the current playlist.
...
To view your top tracks for a specific time frame you can view them within the "Top Tracks" section of the page.
...
Click the "+ Create Playlist" button to create a playlist from the tracks currently displayed.

### Top Artists

To view your top artists for a specific time frame you can view them within the "Top Artists" section of the page.
...
You can view information on how to use the application and how to use it on this page.
